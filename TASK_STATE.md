...
- 当前分支包含 MSDS/TDS 的独立历史，但交接复核时工作区为 clean；owner: MSDS 维护者；unblock: 继续以 `fbcdd958547b090ce74c5c5bb39298842062bc53` 作为 MSDS v3.14.2 功能基线，后续改动前核对分支、HEAD 和工作区，并保持两套 Skill 边界。
