...
HEADINGS={'产品描述':'product.description','Characterization':'product.description','供应形式':'product.supply_form','Supply Form':'product.supply_form','产品特性':'product.features','Product features':'product.features','应用':'product.application','Application':'product.application','储存':'product.storage','Storage':'product.storage'}
def main():
