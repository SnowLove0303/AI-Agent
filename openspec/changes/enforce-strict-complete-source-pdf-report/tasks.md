...
- [x] Update the judge API and CLI to enforce strict closed-world outcomes and explicit uncertainty opt-in.
- [x] Add the minimal DOCX-to-PDF report generator and output verification.
