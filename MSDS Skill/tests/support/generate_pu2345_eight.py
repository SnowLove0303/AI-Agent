...
def build_one(language: str, brand: str):
    ...
    audit = {
        ...
        "template_geometry": {"table_count": 16, "rows": [10, 16, 6, 6, 5, 4, 3, 16, 24, 6, 18, 6, 3, 5, 9, 2]},
        "output_geometry": {"table_count": 16, "rows": [10, 16, 8, 6, 5, 4, 3, 16, 14, 6, 18, 6, 3, 5, 9, 2], "s3_component_rows": 4},
