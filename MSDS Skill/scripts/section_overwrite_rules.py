...
LOCAL_SECTION_POLICIES = {
    2: {"match_basis": "semantic_route_with_product_component_scope", "source_text_policy": "verbatim_product_s2_facts plus explicit reviewed cross-section route of component GHS classification/H-code evidence into S2.1; S2.2/S2.3 only special-substance attention note; strip classification/H-code lines from that note and retain a threshold only as part of the note; no-pictogram=>无象形图; S2.5 heading plus hanging detail paragraphs", "empty_policy": "hide_then_renumber"},
